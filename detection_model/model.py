...
from detection_model.common import * 
from detection_model.experimental import *
...
# class ReparamBackboneModel(nn.Module):
...
# class DiseaseDetection(nn.Module):
#     def __init__(self, backbone=None) -> None:

#         self.backbone = backbone if backbone==None else 
#         super().__init__()
...
class Model(nn.Module):
    def __init__(self, cfg='yolor-csp-c.yaml', ch=3, nc=None):
        ...
        ch = self.yaml['ch'] = self.yaml.get('ch', ch) # input_channels(3)
